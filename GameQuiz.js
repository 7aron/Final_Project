...
const questions =[
  ...
  ["Which weapon do you prefer?","QuizWeapon2.jpg","dynamite.png","hammer.png","QuizWeapon1.jpg"],
...
const startTheGame= function ()//Taron
{
  ...
  quiz.innerHTML="<a href='ending.html'><img src='"+source+"' width=500 height=500 id='result'></a>";
  alert("Type: Sticker");
